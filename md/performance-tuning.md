...
* **Red Hat Wildfly** : add the attributes `io-threads="10"` and `task-max-threads="200"` in the _default_ *worker* element in the io subdomain in _`<WILDFLY_HOME>/standalone/configuration/standalone.xml`.   
